...
# OBJECTS
ball = sphere(pos=(-2,2,0), radius=0.5, color=color.cyan)
...
start = box(pos = (-2,2,0), length = 1, height = 1, width = .01, material = materials.ice, color=color.green)
stop = box(pos = (4,4,0), length = 1, height = 1, width = .01, material = materials.ice, color=color.red)
